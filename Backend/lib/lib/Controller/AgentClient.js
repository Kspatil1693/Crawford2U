...
exports.registerAgent = async (request, response, next) => {
  try {
    ...
    const agentData = await AgentDetails.find({
    ...
    var agentCode = areaCodeLetter + agentCodeData + firstName.charAt(0) + middleName.charAt(0) + lastName.charAt(0);
...
exports.registerClient = async (request, response, next) => {
  try {
    ...
    const clientData = await ClientDetails.find({
    ...
    const phoneNumber1 = await AgentDetails.find({
      phoneNumber: phoneNumber
    });
...
exports.agentLogout = async (request, response, next) => {
  try {
    ...
    const data = await AgentDetails.updateOne({
      phoneNumber: phoneNumber
    }, {
      $unset: {
        authToken: ""
...
exports.clientLogout = async (request, response, next) => {
  try {
    ...
    const data = await ClientDetails.updateOne({
      clientPhoneNumber: clientPhoneNumber
    }, {
      $unset: {
        authToken: ""
...
exports.getOneAgentDetails = async function (request, response, next) {
  try {
    ...
    const agentDetails = await AgentDetails.find({
      phoneNumber: phoneNumber
    });
...
exports.updateAgentDetails = async function (request, response, next) {
  try {
    ...
    var agentCode = agentCodeData + pincode.slice(3, 6) + firstName.slice(0, 1) + middleName.slice(0, 1) + lastName.slice(0, 1);
    const agentDetails = await AgentDetails.findOne({
      phoneNumber: phoneNumber
    });
...
exports.deleteAgent = async function (request, response, next) {
  try {
    ...
    const agentDetails = await AgentDetails.deleteOne({
      phoneNumber: phoneNumber
    });
...
exports.deleteClient = async function (request, response, next) {
  try {
    ...
    const clientDetails = await ClientDetails.deleteOne({
      clientPhoneNumber: clientPhoneNumber
    });
